document.addEventListener('DOMContentLoaded', function() {
    ...
    if (!isMobile) {
        ...
        const handleClick = (direction) => {
            const now = Date.now();
            if (now - lastClickTime < 500) return; // Debounce navigation clicks
            lastClickTime = now;
    ...
    window.addEventListener('resize', () => {
        ...
        // Reset scroll position to nearest card center
    ...
    function ensureProperScroll() {
        ...
        container.addEventListener('scroll', () => {
            ...
            scrollTimeout = setTimeout(() => {
                ...
                if (scrollLeft + containerWidth >= containerScrollWidth - 10) {
                    // We're at the right edge, ensure last card is centered
                ...
                if (scrollLeft <= 10) {
                    // We're at the left edge, ensure first card is centered
