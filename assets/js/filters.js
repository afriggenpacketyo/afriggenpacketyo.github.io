...
function showExcludesContent() {
  ...
  if (!excludesContent) {
    ...
    excludesContent.innerHTML = `
      ...
      <textarea id="excludes-input" placeholder="e.g., ice cream, beaches" style="width: 100%; min-height: 100px; padding: 0.75rem; border: 2px solid #e9ecef; border-radius: 8px; font-size: 1rem; resize: vertical; font-family: inherit;">${existingExcludes}</textarea>
